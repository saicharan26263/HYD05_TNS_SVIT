...
public class PrimitiveDataTypesDemo {
	public static void main(String[] args) {
		...
		long maxLong=922372036854775807L;
		long minLong =-9223372036854775808L;
		System.out.println("Minint range of byte is "+minLong+"Maxint range of byte is"+maxLong);
		float f=3234.141243278345f;
		double d=3456.14124512345678902345678914f;
		System.out.println("Minint range of byte is "+f+"Maxint range of byte is"+d);
		boolean flag=false;
